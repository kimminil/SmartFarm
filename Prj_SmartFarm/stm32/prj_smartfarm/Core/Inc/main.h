...
/* Private defines -----------------------------------------------------------*/
#define Fan_Peltier1_Pin GPIO_PIN_0
#define Fan_Peltier1_GPIO_Port GPIOC
#define Fan_Peltier2_Pin GPIO_PIN_1
#define Fan_Peltier2_GPIO_Port GPIOC
